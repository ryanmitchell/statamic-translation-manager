<?php
  ...
  return [
    ...
    "blueprint_scan" => "Blueprintscan",
    "check_for_missing_translations" => "Controleer op missende vertalingen",
    "manage_translations" => "Beheer vertalingen",
    "manage_translation_locale" => "Beheer de vertalingen in :locale",
    "missing_translations" => ":count missing translation|:count missing translations",
    "no_missing_translations" => "Er zijn geen missende vertalingen.",
    "scan_blueprints" => "Scan blueprints",
    "scan_blueprints_desc" => "Scan blueprints op missende strings en voeg ze toe aan je taalbestanden.",

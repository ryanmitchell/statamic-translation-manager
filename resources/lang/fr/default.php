<?php
  ...
  return [
    ...
    "blueprint_scan" => "Scan des Blueprints",
    "check_for_missing_translations" => "Trouver les traductions manquantes",
    "manage_translations" => "Gérer les traductions",
    "manage_translation_locale" => "Gérer la traduction pour :locale",
    "missing_translations" => ":count missing translation|:count missing translations",
    "no_missing_translations" => "Toutes les traductions ont été effectuées.",
    "scan_blueprints" => "Scan des Blueprints",
    "scan_blueprints_desc" => "Scannez vos Blueprints à la recherche de chaînes manquantes et ajoutez-les à vos packs de langue.",
